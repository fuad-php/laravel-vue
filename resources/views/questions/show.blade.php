                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <form action="/questions/{{ $question->id }}/vote" method="post" id="up-vote-question-{{$question->id}}">
                                @csrf
                            ...
                            <form action="/questions/{{ $question->id }}/favorites" method="post" id="favorite-question-{{$question->id}}">
                                @csrf
